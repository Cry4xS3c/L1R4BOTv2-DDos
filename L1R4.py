                ...
                @@@@@@  @@ @@ @@ @@ @@ @@ @ @@@@@@
                  @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
                    @@@@@@@@@@@@@@@@@@@@@@@@@@
                      @@@@@@@@@@@@@@@@@@@@@@
\033[0m  
\033[92m                                                                                                                                                                    _        ________                  ________  ________                      
`MM'        `MMMMMMMb.                `MMMMMMMb.`MMMMMMMb.                    
 MM          MM    `Mb                 MM    `Mb MM    `Mb                    
 MM      __/ MM     MM                 MM     MM MM     MM   _____     ____   
 MM      `MM MM     MM      ,M         MM     MM MM     MM  6MMMMMb   6MMMMb\ 
 MM       MM MM    .M9     ,dM         MM     MM MM     MM 6M'   `Mb MM'    ` 
 MM       MM MMMMMMM9'    ,dMM         MM     MM MM     MM MM     MM YM.      
 MM       MM MM  \M\     ,d MM         MM     MM MM     MM MM     MM  YMMMMb  
 MM       MM MM   \M\   ,d  MM         MM     MM MM     MM MM     MM      `Mb 
 MM    /  MM MM    \M\ ,d   MM         MM    .M9 MM    .M9 YM.   ,M9 L    ,MM 
_MMMMMMM _MM_MM_    \M\MMMMMMMM       _MMMMMMM9'_MMMMMMM9'  YMMMMM9  MYMMMM9  
                            MM                                                
                            MM                                                
                            MM      							
\033[0m         
...
def httpcall(url):
	...
	try:
			...
			#print e.code
			set_flag(1)
 			print ("\033[35m Ataque iniciado By:@L1R4 \033[0m")
			code=500
...
if len(sys.argv) < 2:
	...
	if sys.argv[1]=="help":
		...
		print ("Ataque iniciado com sucesso programa feito por : @L1R4")
		if len(sys.argv)== 3:
			if sys.argv[2]=="safe":
				set_safe()
		url = sys.argv[1]
